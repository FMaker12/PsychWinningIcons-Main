...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Extras'],
			['FMaker12',			'fmaker',			'Compilator',							'https://www.youtube.com/channel/UCzhv9aKq6dRsUu5Pbh876Rw', '4D5DBD'],
			['TronReaper',			'tron',				'o maluco que fez o codigo lá',				  'https://www.youtube.com/watch?v=fI3_4P6tKtw&t=218s', '4D5DBD']
		];
